...
d3.csv("../data/Bicycle_Thefts_Open_Data.csv").then(data => {
    ...
    const divisionData = getTop7(data, "DIVISION");
    const locationTypeData = getTop7(data, "LOCATION_TYPE");
    const premisesTypeData = getTop7(data, "PREMISES_TYPE");

    // Define chart dimensions
    const width = 500, height = 300, margin = { top: 20, right: 20, bottom: 70, left: 50 };
